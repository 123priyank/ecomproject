                                        ...
                                        <div id="demo-1" class="simpleLens-gallery-container">
                                            <div class="simpleLens-container">
                                                <div class="simpleLens-big-image-container"><a
                                                        data-lens-image="{{asset('main_image/'.$product[0]->image)}}"
                                                        class="simpleLens-lens-image"><img
                                                            src="{{asset('main_image/'.$product[0]->image)}}"
                                                            class="simpleLens-big-image"></a></div>
                                            </div>
                                            <div class="simpleLens-thumbnails-container">
                                                <a data-big-image="{{asset('main_image/'.$product[0]->image)}}"
                                                   data-lens-image="{{asset('main_image/'.$product[0]->image)}}"
                                                   class="simpleLens-thumbnail-wrapper" href="#"><img
                                                        src="{{asset('main_image/'.$product[0]->image)}}" width="70px">
                                                </a>
                                                ...
                                                @if(isset($product_images[$product[0]->id][0]))
                                                    ...
                                                    @foreach($product_images[$product[0]->id] as $list)
                                                        ...
                                                        <a data-big-image="{{asset('varient_image/'.$list->images)}}"
                                                           data-lens-image="{{asset('varient_image/'.$list->images)}}"
                                                           class="simpleLens-thumbnail-wrapper" href="#"><img
                                                                src="{{asset('varient_image/'.$list->images)}}"
                                                                width="70px">
                                                        </a>
                                        ...
                                        @if($product_attr[$product[0]->id][0]->size_id>0)
                                            ...
                                            <div class="aa-prod-view-size">
                                                ...
                                                @foreach($arrSize as $attr)
                                                    ...
                                                    @if($attr!='')
                                                        <a href="javascript:void(0)" onclick="showColor('{{$attr}}')"
                                                           id="size_{{$attr}}" class="size_link">{{$attr}}</a>
                                                    @endif
                                                @endforeach
                                            </div>
                                        @endif
                                            ...
                                            <div class="aa-color-tag">
                                                ...
                                                @foreach($product_attr[$product[0]->id] as $attr)
                                                        ...
                                                        <a href="javascript:void(0)"
                                                           ...
                                                           onclick=change_product_color_image("{{asset('attrimage/'.$attr->attr_image)}}","{{$attr->color}}")></a>
                                                @endforeach
                                            </div>
                                        @endif
                                        ...
                                        <li>
                                            <figure>
                                                ...
                                                <a class="aa-add-card-btn"
                                                   href="{{url('front/product/'.$productArr->slug)}}"><span
                                                ...
                                                <figcaption>
                                                    ...
                                                    <span
                                                        class="aa-product-price">Rs {{$related_product_attr[$productArr->id][0]->price}}</span><span
